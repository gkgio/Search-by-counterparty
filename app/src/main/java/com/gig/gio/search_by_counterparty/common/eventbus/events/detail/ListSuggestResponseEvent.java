package com.gig.gio.search_by_counterparty.common.eventbus.events.detail;
...
public class ListSuggestResponseEvent {
    ...
    public ListSuggestResponseEvent(List<SuggestResponse> suggestResponseList, SuggestResponse suggestResponse) {
